...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    if(keyDown(kangarooTouched.shrub3)){
      collidedSound.play();
      gameState = END;
    }

    if(keyDown(kangarooTouched.obstacleGroup)){
      collidedSound.play();
      gameState = END;
    }
    ...
    if(keyDown(kangarooTouched.shrub1)){
      score = score + 1;
      shrubsGroup.destroyEach();
    }

    if(keyDown(kangarooTouched.shrub2)){
      score = score + 1;
      shrubsGroup.destroyEach();
    }
...
function reset(){
  ...
  kangaroo.changeAnimation("kangaroo1");
  kangaroo.addAnimation("kangaroo2");
  kangaroo.loadAnimation("kangaroo2");
  kangaroo.changeAnimation("kangaroo2");
  kangaroo.addAnimation("kangaroo3");
  kangaroo.loadAnimation("kangaroo3");
  shrubs.destroy();
